...
public class MaximizeTwoDifferentPickingToys {

	public static int maximizeSubarraysByKUniqueToys(String str, int k) {
		int max = 0;
		int i = 0, j = 0;
...
//				j++;
	...
	public static void main(String[] args) {
		String str = "abaccab";
		int k = 2;
		System.out.println(maximizeSubarraysByKUniqueToys(str, k));
