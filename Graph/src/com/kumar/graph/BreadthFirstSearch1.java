...
public class BreadthFirstSearch1 {
    public static void main(String[] args) {
        ...
        int[] used = new int[n + 1]; // declaring an empty used array where in used[i] = 0 means this node has not yet been visited in our algorithm
        used[1] = 1; // 1st node has been visited hence setting it as 1 and it is inserted in the queue as well

        int[] lvl = new int[n + 1]; // declaring level array which lets us know level of each node
